...
#define USAGE_SIG_ALGS \
    ...
    "                        example: \"ecdsa_secp384r1_sha384, ecdsa_secp256r1_sha256\"\n"  
#else
#define USAGE_SIG_ALGS ""
#endif
    ...
    if( opt.sig_algs != NULL )
    {
        ...
        if( strcmp( p, "default" ) != 0 )
        {
            ...
            while( i < SIG_ALG_LIST_SIZE - 1 && *p != '\0' )
            {
                ...
                {
                    sig_alg_list [i++] = MBEDTLS_SIG_ECDSA_SECP256r1_SHA256;
                }
                else if( strcmp( q, "ecdsa_secp384r1_sha384" ) == 0 )
                {
                    sig_alg_list [i++] = MBEDTLS_SIG_ECDSA_SECP384r1_SHA384;
                }
                else if( strcmp( q, "ecdsa_secp521r1_sha512" ) == 0 )
                {
                    sig_alg_list [i++] = MBEDTLS_SIG_ECDSA_SECP521r1_SHA512;
                }
                else
                {
            ...
            sig_alg_list [i] = MBEDTLS_SIG_NONE;
        }
    }
