...
#define USAGE_TLS1_3_KEY_EXCHANGE_MODES \
    ...
    "                          options: psk, psk_ephemeral, ephemeral, ephemeral_all, psk_all, all, psk_or_ephemeral\n"
#else
#define USAGE_TLS1_3_KEY_EXCHANGE_MODES ""
        ...
        *q++ = '\0';
        ...
        else if( strcmp( p, "tls13_kex_modes" ) == 0 )
        {
            if( strcmp( q, "psk" ) == 0 )
                ...
                opt.tls13_kex_modes = MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK | MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL;
            else goto usage;
        }
#endif /* MBEDTLS_SSL_PROTO_TLS1_3 */
