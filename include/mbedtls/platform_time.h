...
/**
 * \brief Time function in milliseconds.
 *
 * \return Current time in  milliseconds
 *
 * \note If MBEDTLS_PLATFORM_MS_TIME_ALT defined, user can provide their own
 *       implementation.
 */
extern mbedtls_ms_time_t mbedtls_ms_time( void );
