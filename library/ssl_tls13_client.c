                                    ...
                                    const unsigned char *end )
{
    ...
    MBEDTLS_SSL_CHK_BUF_READ_PTR( buf, end,
                    2 + sizeof( mbedtls_ssl_tls13_hello_retry_requst_magic ) );

    if( memcmp( buf + 2, mbedtls_ssl_tls13_hello_retry_requst_magic,
                sizeof( mbedtls_ssl_tls13_hello_retry_requst_magic ) ) == 0 )
    {
